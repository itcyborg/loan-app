                    ...
                    <div id="addUser">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <div class="title">Edit Charge</div>
                            </div>
                            <div class="card-body">
                                <div class="form">
                                    <form @submit.prevent="editCharge">
                                        <div class="row">
                                            <div class="col-6">
                                                <label>Product</label>
...
export default {
    ...
    methods: {
        editCharge:function() {
            axios.patch('/api/charge/'+this.$route.params.id,this.form)
            .then((res)=>{
                if(res.status==201){
                    this.$toast.success('Charge Updated Successfully',{
                        position:'top-right'
                    });
                    this.form.name='';
                }
        ...
        getCharge:function(id){
            console.log(id);
            axios.get('/api/charge/'+id).then((res)=>{
